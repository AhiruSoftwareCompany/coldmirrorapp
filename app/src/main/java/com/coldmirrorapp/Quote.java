...
class Quote {
    private static Quote[] quoteArray = {
            ...
            new Quote(Category.harrypotter, "achdumeinescheisse", "Ach du meine Scheiße!"),
            new Quote(Category.harrypotter, "besseralsnichts", "Besser als\nnichts"),
            new Quote(Category.harrypotter, "blitzaufderstirn", "Blitzchen auf\nder Stirn"),
            new Quote(Category.harrypotter, "chefgehtrueckwaerts", "Chef geht rückwärts"),
            new Quote(Category.harrypotter, "dasheissteristgeradeindeutschland", "Das heißt, er ist gerade in Deutschland?"),
            new Quote(Category.harrypotter, "dasistdeinproblemmeinfreund", "Das ist dein Problem mein Freund"),
            new Quote(Category.harrypotter, "dasistmiregal", "Das ist mir egal."),
            ...
            new Quote(Category.harrypotter, "dubistsodumm", "Du bist so dumm!"),
            new Quote(Category.harrypotter, "duoberpflaume", "Du\nOberpflaume"),
            new Quote(Category.harrypotter, "einaufmuepfigerarbeiter", "Ein aufmüpfiger Arbeiter!"),
            new Quote(Category.harrypotter, "einelampe", "eine Lampe"),
            new Quote(Category.harrypotter, "excuseme", "Excuse Me?!"),
            new Quote(Category.harrypotter, "frittenbudenjingle", "McD Jingle"),
            new Quote(Category.harrypotter, "geilekarten", "Geile Karten"),
            new Quote(Category.harrypotter, "genuggefreut", "Genug gefreut"),
            new Quote(Category.harrypotter, "getuschel", "Getuschel über Snape"),
            new Quote(Category.harrypotter, "harrybeimfrauenarzt", "Harry beim Frauenarzt"),
            ...
            new Quote(Category.harrypotter, "herminekauftbuecher", "Hermine kauft Bücher"),
            new Quote(Category.harrypotter, "hitler", "Hitler?"),
            new Quote(Category.harrypotter, "howtobildung", "How to:\nBildung"),
            new Quote(Category.harrypotter, "huhwerbistdudenn", "Hö? Wer bist du denn?"),
            ...
            new Quote(Category.harrypotter, "manchmalmussichuebermichselberlachen", "Manchmal muss ich über mich selbst lachen."),
            new Quote(Category.harrypotter, "meinebuecher", "MEINE Bücher."),
            new Quote(Category.harrypotter, "neunzehnhundertzwoelfundachzig", "Neunzehnhundertzwölfundachzig"),
            ...
            new Quote(Category.harrypotter, "penisamputiertenmistkaefer", "Ihr penisamputierten Mistkäfer"),
            new Quote(Category.harrypotter, "purezauberei", "Pure Zauberei"),
            new Quote(Category.harrypotter, "rechenichsoviel", "Rechne nich so viel, Ron."),
            new Quote(Category.harrypotter, "scheissaufdiedrittewelt", "Scheiß auf die dritte Welt!"),
            ...
            new Quote(Category.harrypotter, "toplehrer", "Top Lehrer!"),
            ...
            new Quote(Category.harrypotter, "weristflori", "Wer ist Flori?"),
