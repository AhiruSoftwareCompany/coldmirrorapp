...
class Quote {
    private static Quote[] quoteArray = {
            ...
            new Quote(Category.harrypotter, "hagridwitz", "Hagrids Witz", "5 Minuten Harry Podcast #5"),
            ...
            new Quote(Category.random, "kindheitgeloescht", "Kindheits- erinnerung gelöscht"),
            ...
            new Quote(Category.random, "richtiglame", "Richtig l a m e"),
            ...
            new Quote(Category.random, "totalgetriggert", "Total getriggertt"),
